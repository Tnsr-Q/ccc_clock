...
class ThetaLoop:
    ...
    def reverse(self) -> 'ThetaLoop':
        ...
        return ThetaLoop(
            ...
            direction=LoopDirection.REVERSED if self.direction == LoopDirection.NORMAL else LoopDirection.NORMAL
        )
...
class WitnessChannel:
    ...
    def generate_trace(self, time_array: np.ndarray, 
                      systematic_amplitude: float = 1e-19) -> np.ndarray:
        """
...
class OrthogonalityTest:
    ...
    def _commuting_loop_test(self, signal_normal: float, signal_test: float) -> Dict:
        ...
        return {
            'passed': suppression < 0.15,  # Should be strongly suppressed (more realistic threshold)
    ...
    def _entanglement_test(self, signal_normal: float, signal_test: float) -> Dict:
        ...
        return {
            'passed': enhancement > 1.2,  # Should be enhanced (more realistic threshold)
